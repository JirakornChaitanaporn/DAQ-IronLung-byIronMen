...
from models.pm10_predictor_lr import predict
...
# ===========================================================================
print("\n-- Monotonicity: higher outdoor PM10 -> higher indoor PM10 (LR) ---")
# ===========================================================================
...
run("higher outdoor PM10 gives higher prediction (LR)",  test_higher_outdoor_increases_prediction)
run("predictions increase across PM10 steps (LR)",       test_monotonic_pm10_steps)
...
run("all AQI values return valid outputs (LR)",           test_aqi_range_all_valid)
...
scenarios = [
    ...
    ("cool night, moderate dust",  dict(pm10_outdoor=15.0, windspeed=2.5, aqi=90,  temp_outdoor=27.0, humid=70)),
]
...
def test_minimum_realistic_inputs():
    r = base_predict(pm10_outdoor=5.4, windspeed=0.0, aqi=50, temp_outdoor=25.0, humid=30)
    assert 0 < r < 100

def test_maximum_realistic_inputs():
    r = base_predict(pm10_outdoor=29.5, windspeed=12.0, aqi=150, temp_outdoor=40.0, humid=95)
    assert 0 < r < 100
