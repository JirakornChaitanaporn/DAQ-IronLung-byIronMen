...
scenarios = [
    ("clean day, low wind",        dict(pm25_outdoor=8.0,  windspeed=2.0, aqi=60,  temp_outdoor=29.0, humid=75)),
    ...
    ("hot and humid, calm",        dict(pm25_outdoor=16.0, windspeed=1.5, aqi=85,  temp_outdoor=36.0, humid=84)),
    ("cool night, moderate dust",  dict(pm25_outdoor=13.0, windspeed=2.5, aqi=90,  temp_outdoor=27.0, humid=70)),
]
...
def test_minimum_realistic_inputs():
    r = base_predict(pm25_outdoor=4.3, windspeed=0.0, aqi=50, temp_outdoor=25.0, humid=30)
    assert 0 < r < 80

def test_maximum_realistic_inputs():
    r = base_predict(pm25_outdoor=26.6, windspeed=12.0, aqi=150, temp_outdoor=40.0, humid=95)
    assert 0 < r < 80
