...
MODEL_PATH = os.path.join(os.path.dirname(__file__), "trained_models/pm10_model_lr.joblib")
SCALER_PATH = os.path.join(os.path.dirname(__file__), "trained_models/pm10_scaler_lr.joblib")
